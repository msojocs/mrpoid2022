 ...
 */
public class AppProcessService extends Service implements IMessageCodes, Callback {
    static final String TAG = AppProcessService.class.getSimpleName();
    ...
    private boolean sendMsg(Messenger remote, int what, int arg0, int arg1, Bundle bundle) {
        if (remote == null) {
            Log.e(TAG, "who am I talking with? remote lost!");
            return false;
        }
    ...
    public IBinder onBind(Intent intent) {
        Log.i(TAG, "onBind:" + intent + "pid=" + Process.myPid());
